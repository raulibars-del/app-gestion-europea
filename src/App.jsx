...
const ROL_MODULOS = {
  manager:  ["dashboard","asistencia","clientes","ventas","tareas","partes","albaran","stock","inventario","documentacion","calendario","chat","fichaje","usuarios","ajustes"],
  admin:    ["dashboard","asistencia","clientes","ventas","tareas","partes","albaran","stock","inventario","documentacion","calendario","chat","fichaje"],
  tecnico:  ["dashboard","asistencia","clientes","tareas","partes","albaran","inventario","documentacion","calendario","chat","fichaje"],
  comercial:["dashboard","asistencia","clientes","ventas","albaran","stock","inventario","documentacion","calendario","chat","fichaje"],
};
...
const initialData = {
  usuarios: [
    ...
    { id:0,nombreEmpresa:"Europea de Maquinaria PMM SL",nombreFiscal:"Europea de Maquinaria PMM SL",cif:"B98527583",localidad:"Torrent (Valencia)",esCliente:false,esPropia:true,dirFiscal:"Carrer Mas del Jutge 33",cpFiscal:"46900",provinciaFiscal:"Valencia",contactos:[{id:1,nombre:"Europea de Maquinaria",puesto:"Gerente",tel:"",email:"info@europeademaquinaria.com",principal:true}],maquinas:[],notas:"Cuenta interna — máquinas propias, trabajos internos y albaranes propios." },
                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(130px,1fr))",gap:14,alignItems:"start",marginBottom:16}}>
                  ...
                  <div>
                    ...
                    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(min(260px,100%),1fr))",gap:"3px 14px"}}>
                      {[["Marca",m.marca],["Modelo",m.modelo],["Nº serie",m.serie],["Año",m.anyo]].map(([l,v])=>v?<div key={l}><span style={{color:"#6b7a99",fontSize:11}}>{l}: </span><span style={{color:"#f1f3f9",fontSize:12,fontWeight:600}}>{v}</span></div>:null)}
                    </div>
...
<div style={{color:"#6b7a99",fontSize:12,marginTop:2}}>Matricula: {m.matricula} - Anyo: {m.anyo}</div>
</div>
